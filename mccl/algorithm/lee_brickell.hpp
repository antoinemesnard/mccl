...
static inline vec solve_SD_lee_brickell(const syndrome_decoding_problem& SD)
{
...
static inline vec solve_SD_lee_brickell(const syndrome_decoding_problem& SD, const configmap_t& configmap)
{
